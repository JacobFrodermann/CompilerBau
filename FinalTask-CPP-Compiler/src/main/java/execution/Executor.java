...
public class Executor {
  ...
  private Object evaluateExpression(Expression expr) {
    return switch (expr) {
      ...
      case Expression.CharLiteral lit -> lit.value();
  ...
  private Object evaluateMethodCall(
      ObjectInstance obj, String methodName, List<Expression> arguments) {
    // Argumente auswerten
    List<Object> argValues = new ArrayList<>();
    for (Expression arg : arguments) {
      argValues.add(evaluateExpression(arg));
  ...
  private ClassMember.MethodDef findMethod(
      Declaration.ClassDef classDef, String name, List<Object> argValues) {
  ...
  private void executeConstructorBody(
      ObjectInstance obj, Declaration.ClassDef classDef, List<Object> argValues) {
