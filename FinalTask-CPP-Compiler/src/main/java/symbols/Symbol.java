...
public sealed interface Symbol {
  ...
  public final class FunctionSymbol implements Symbol {
    ...
    public FunctionSymbol(
        String name, Type returnType, List<Parameter> parameters, Statement.Block block) {
      this.name = name;
      this.returnType = returnType;
      this.parameters = parameters;
      this.block = block;
    ...
    public Signature signature() {
      List<Type> types = parameters.stream().map(Parameter::type).collect(Collectors.toList());
      List<Boolean> refs =
          parameters.stream().map(Parameter::isReference).collect(Collectors.toList());
  ...
  final class ClassSymbol implements Symbol {
    ...
    public void setBaseClass(ClassSymbol base) {
      this.baseClass = base;
    }
    ...
    private boolean matchesCall(
        FunctionSymbol func, List<Type> argTypes, List<Boolean> argIsLValue) {
    ...
    public Map<String, List<FunctionSymbol>> getAllMethods() {
      return methods;
    }
